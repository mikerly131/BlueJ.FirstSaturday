...
public class WriteIFs
{
    ...
    public void playerDied(boolean player1) {
        ...
        if (isAlive(player1)) {
            // Check If Ture: Passing the boolean to the isAlive method
            // which will return the opposite value - so say we pass false, returns true.
            // When result of If check is true, do nothing
    ...
    public String thermoSTAT(int room) {
        ...
        // Write an IF statement that check “temperature(room)” 
        // if that check is less than 70, 
